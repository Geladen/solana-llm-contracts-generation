...
declare_id!("8YXB9CiVJQCrwQXzEGRDgyQbeNcrqUcm5KJ6LehMwspy");
...
impl anchor_lang::Space for LotteryState {
...
impl anchor_lang::Space for LotteryInfo {
    const INIT_SPACE: usize = 1 + 32 + 32 + 32 + (4 + 30) + 32 + (4 + 30) + 8;
}
